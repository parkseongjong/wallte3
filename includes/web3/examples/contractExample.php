...
$contractAddress = '0xd2b8dD73BB6E170748c0747FEaEb92f818BcC141';
//$contract = new Contract($web3->provider, $testAbi);
$functionName = "balanceOf";
$params = "0x10e9fab66554cb046503b6dbcd73e1381e0aad45";
//$params = "0xbfbbe2be1890e3463f6fe61bb1e21daf6406af95";
$contract = new Contract($web3->provider, $testAbi);

//$contract->at($contractAddress)->call($functionName, $params, $callback);
/*  $functionData = $contract->at($contractAddress)->call($functionName, $params,function($err, $result){
	print_r($err);
	echo "=========>";
	print_r($result['balance']->toString());
});
 die; */
...
$params1 = '2000';
 ...
 $contract->at($contractAddress)->send('transfer', $toAccount, 500000, [
                        'from' => $fromAccount,
						'gas' => '0x33450'
...
/*  $functionData = $contract->at($contractAddress)->send($functionName, $params, $params1, function($err, $result){
	var_dump($err);
	echo "=========>";
	var_dump($result);
}); */
