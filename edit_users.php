...
if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
   ...
   // $data_to_update['updated_at'] = date('Y-m-d H:i:s');
	...
	$updateArr['email'] =  $data_to_update['phone'];
    ...
    <form class="" action="" method="post" enctype="multipart/form-data" id="contact_form">
       ...
       <fieldset>
			<div class="form-group">
				...
				<input type="text" name="phone" value="<?php echo $edit ? $users['phone'] : ''; ?>" placeholder="Phone" class="form-control" required="required" id="phone">
			</div> 
