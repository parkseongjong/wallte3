...
// select the columns
$select = array();// array('id', 'name','wallet_address','email' ,'created_at');
...
$result = $db->arraybuilder()->paginate("user_transactions", $page, $select);
    ...
    <table class="table table-striped table-bordered table-condensed">
        ...
        <tbody>
            ...
            <tr>
				...
				<td><?php echo htmlspecialchars($row['reciver_address']) ?></td>
				<td><?php echo htmlspecialchars($row['amount']) ?></td>
				<td><?php echo htmlspecialchars($row['fee_in_gcg']) ?></td>
